                        ...
                        <div className="relative">
                            ...
                            {isMoreOpen && (
                                <div className="absolute top-full right-0 mt-2 w-48 bg-gray-900 border border-gray-800 rounded-lg shadow-xl py-2">
                                    <button onClick={() => setCurrentPage('success-stories')} className="flex items-center gap-2 px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-orange-500 transition-colors w-full text-left">
